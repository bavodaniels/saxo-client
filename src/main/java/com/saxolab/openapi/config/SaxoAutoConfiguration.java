...
public class SaxoAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public SaxoOAuthService saxoOAuthService(SaxoOAuthClient oAuthClient, SaxoOAuthTokenStore tokenStore, SaxoProperties properties) {
        return new SaxoOAuthService(oAuthClient, tokenStore, properties);
    }
    ...
    public RestClient saxoApiRestClient(SaxoProperties properties, SaxoAuthInterceptor authInterceptor) {
        return RestClient.builder()
